...
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002118749159"))
...
USER_REPLY_TEXT = "❌ Don't send me messages directly I'm only File Share bot !👨‍💻 Bot Devloper @Orewa_Zoro_San < >"
